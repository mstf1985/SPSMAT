function out=Cby_3_(N,derv,X,u_) 
%
% Overview
% This function returns a Shifted Chebyshev (3rd kind) matrix functions. 
%     
%out = Cby_3_(N,derv,X,u_)
%
%inputs: 
%------------------------------------------------------ 
%| N     : integer          : From Chebyshev(3rd kind)|
